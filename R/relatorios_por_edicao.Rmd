...
<div class="leftcol" style="width:70%;flex: 6 1 600px; position:relative;display:flex;">
...
<div class="rightcol" style="width:29%;flex: 3 1 250px; position:relative;display:flex;">
